...
for ii = 1:length(pressures)
    ...
    methaneDensitiesIdealGas(ii) = computeIdealGasDensity(pressures(ii), temperatureC,"ch4");
    co2DensitiesIdealGas(ii) = computeIdealGasDensity(pressures(ii), temperatureC,"co2");
end
